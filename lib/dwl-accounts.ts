...
const DWL_PUBLIC_AUTH_RETURN_URL = readEnv("NEXT_PUBLIC_DWL_AUTH_RETURN_URL");
export const DWL_AUTH_RETURN_URL = DWL_PUBLIC_AUTH_RETURN_URL || readEnv("DWL_AUTH_RETURN_URL");
export const DWL_DEFAULT_AUTH_RETURN_URL =
  DWL_PUBLIC_AUTH_RETURN_URL || new URL(DEFAULT_RETURN_PATH, DEFAULT_APP_ORIGIN).toString();
